...
def get_argparser():
    ...
    parser.add_argument("--soft_weight_root", default="/home/xuzhan/Documents/DRS_related/soft_weight_6_10_2021",
                        type=str, help="The root of the soft weight labels")
    parser.add_argument("--seg_labels_root", default="/home/xuzhan/Documents/irn/data/cross_epoch_exp_5/sem_seg",
                        type=str, help="The root of the pseudo segmentation labels")
    parser.add_argument("--train_file_path", default="./datasets/data/infer.txt",
                        type=str, help="The path of image name file for the training stage")
    parser.add_argument("--val_file_path", default="./datasets/data/infer.txt",
                        type=str, help="The path of image name file for the validation stage")
...
def get_dataset(opts):
    ...
    if opts.dataset == 'voc':
        ...
        train_dst = VOCSegmentation(root=opts.data_root, year=opts.year, opts=opts,
    ...
    while True: #cur_itrs < opts.total_itrs:
        ...
        for (images, labels, soft_weight) in train_loader:
            ...
            with torch.cuda.amp.autocast(enabled=opts.amp):
                ...
                loss = F.nll_loss(log_softmax * soft_weight, labels)
